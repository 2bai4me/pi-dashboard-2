"""PricingService — Verwaltet Provider-Preise + Task-Snapshots.
...
KNOWN_PRICING: Dict[str, Dict[str, Any]] = {
    ...
    "ollama/gemma4:12b":          {"input_per_1m": "0",    "output_per_1m": "0"},
    "ollama/gemma3:4b":           {"input_per_1m": "0",    "output_per_1m": "0"},
    "ollama/gemma4-long:latest":  {"input_per_1m": "0",    "output_per_1m": "0"},
    "ollama/qwen3.6:latest":      {"input_per_1m": "0",    "output_per_1m": "0"},
